...
const Contact = () => {
  ...
  return (
    ...
    >
      <div
        className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden bg-[#292d33]`}
      >
      <div
          className=" flex-[0.5] p-8 rounded-"
        >
        ...
        <div
          className="flex flex-[0.2] flex-col md:flex-col items-center justify-center md:space-x-8"
        >
          <div className="flex flex-col md:flex-col items-center justify-center md:space-x-8">

            <Image 
              alt='joao_image'
              className='h-full object-cover w-60 rounded-full mb-4 md:mb-0 opacity-70' src={joao}/>
            <div className=" flex flex-col text-center md:text-left">
              <h2 className="text-xl font-bold mb-2">Name</h2>
              <p className="text-tertiary mb-2">João Borges Mendonça</p>
              <h2 className="text-xl font-bold mb-2">Location</h2>
              <p className="text-tertiary mb-2">Berlin</p>
